    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        .pathMatchers(
                                "/reporting/swagger-ui.html",
                                "/reporting/swagger-ui/**",
                                "/reporting/v3/api-docs/**",
                                "/swagger-resources/**",
                                "/webjars/**",
                                "/test"
                        ).permitAll()
                        .pathMatchers(HttpMethod.GET, "/reporting/api/v1/reports").hasAnyRole("ADMIN", "REPORT_JOB")
                        .pathMatchers("/reporting/actuator/**").permitAll()
